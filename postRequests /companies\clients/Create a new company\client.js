...
// IMPORTANT: THE MULTI CURRENCY FEATURE IF ENABLED ON YOUR SITE WILL REQUIRE YOU TO ADD A CURRENCY VALUE FOR EACH NEW CLIENT. BE AWARE THAT THIS FEATURE CAN NOT BE REVERSED SO PLEASE READ https://support.teamwork.com/projects/finance/multi-currency#before-you-start
// - If you require a list of currency Id's please use the following endpoint: GET: https://${siteName}.teamwork.com/projects/api/v3/currencies.json - note that this enpoint is undocumented but used in app for this purpose
...
const raw = JSON.stringify({
  "company": {
    ...
    "profile": "Public facing notes (in Teamwork.com) go here"/* ,
     "currencyId": 3 // ie: US dollar (USD) = 1, Canadian dollar (CAD) = 2, Euro (EUR) = 3, Pound sterling (GBP) = 4"*/
