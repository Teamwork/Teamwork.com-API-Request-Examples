...
// REQUIRED FIELDS: project id in the URL, date, time, minutes and userId
const myHeaders = new Headers();
const userName = "email address or API KEY here";
const password = "password";
const siteName = "yourSiteName";
const projectId = projectIdHere; // Required -  Int
...
const userId = userIdHere; // Required -  Int
const date = "2024-01-23";  // Required - Format: yyyy-mm-dd as a string
...
const raw = JSON.stringify({
  "timelog": {
    ...
    "projectId": projectId, // Optional in the request body
    "taskId": taskId,
